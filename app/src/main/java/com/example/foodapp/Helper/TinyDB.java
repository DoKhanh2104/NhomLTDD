...
public class TinyDB {
    ...
    public ArrayList<Foods> getListObject(String key){
        ...
        ArrayList<String> objStrings = getListString(key);//lay danh sach duoi dang file json
        ArrayList<Foods> playerList =  new ArrayList<Foods>();//tao danh sach food sau khi lay tu json
        //chuyen tung doi tuong json thanh food
